...
<?php $__env->startSection('content'); ?>
    ...
    <section class="legacy-account-dashboard">
        <div class="legacy-dashboard-row">
            <div class="legacy-box">
                <div class="legacy-box-header">Fees Collection Statistics For - <?php echo e($currentMonthShort); ?></div>
                <div class="legacy-box-body">
                    <div class="legacy-stat-line">
                        <span>RECEIVABLE: <?php echo e($formatAmount($feeOverview['receivable'])); ?> /</span>
                        <span>COLLECTION: <?php echo e($formatAmount($feeOverview['collection'])); ?> /</span>
                        <span>WAIVE OFF: <?php echo e($formatAmount($feeOverview['waive_off'])); ?> /</span>
                        <span>BALANCE: <?php echo e($formatAmount($feeOverview['balance'])); ?> /</span>
                        <span>TODAY COLLECTION: <?php echo e($formatAmount($feeOverview['today_collection'])); ?></span>
                    </div>
            ...
            <div class="legacy-box">
                ...
                <div class="legacy-fee-overview">
                    <?php $__currentLoopData = $feeRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p class="legacy-progress-row">
                            <?php echo e($row['total']); ?> <?php echo e($row['label']); ?>

                            <span>
                                <?php if($row['href']): ?>
                                    <a href="<?php echo e($row['href']); ?>"><?php echo e(round($row['progress'], 2)); ?>%</a>
                                <?php else: ?>
                                    <?php echo e(round($row['progress'], 2)); ?>%
                                <?php endif; ?>
                            </span>
                        </p>
                        <div class="legacy-progress">
                            <div class="legacy-progress-bar" style="width: <?php echo e(min($row['progress'], 100)); ?>%; background: <?php echo e($row['color']); ?>;"></div>
                        </div>
        ...
        <div class="legacy-dashboard-row">
            <div class="legacy-box">
                <div class="legacy-box-header">Expenses For - <?php echo e($currentMonthLong); ?></div>
                <div class="legacy-box-body">
                    <div class="legacy-stat-line legacy-expense-total">
                        <span>TOTAL: <?php echo e($formatAmount($expenseOverview['month_total'])); ?></span>
                        <span>TODAY: <?php echo e($formatAmount($expenseOverview['today_total'])); ?></span>
                    </div>
                    <div class="legacy-chart-wrap">
            ...
            <div class="legacy-box">
                <div class="legacy-box-header">
                    Expenses For - <?php echo e($currentMonthLong); ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            var current_month_days = <?php echo json_encode($days, 15, 512) ?>;
            var days_collection = <?php echo json_encode($dailyCollections, 15, 512) ?>;
            var month_exp_days = <?php echo json_encode($days, 15, 512) ?>;
            var days_exp_paid = <?php echo json_encode($dailyExpenses, 15, 512) ?>;
            var expenseLabels = <?php echo json_encode($expenseOverview['head_labels'], 15, 512) ?>;
            var expenseTotals = <?php echo json_encode($expenseOverview['head_totals'], 15, 512) ?>;
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\TNT\cmslv_git_clone2\resources\views\admin\account\dashboard.blade.php ENDPATH**/ ?>