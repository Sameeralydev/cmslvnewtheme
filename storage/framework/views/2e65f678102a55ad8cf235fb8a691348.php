...
<?php $__env->startSection('content'); ?>
    ...
    <section class="admin-dashboard-section overflow-hidden rounded border border-neutral-300 bg-white shadow-sm">
        <div class="admin-module-tabs flex flex-wrap gap-4 border-b border-amber-300 px-3 py-3">
            <?php $__currentLoopData = $moduleTabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(isset($tab['href'])): ?>
                    <a
                        href="<?php echo e($tab['href']); ?>"
                        class="admin-module-tab <?php echo e(($tab['active'] ?? false) ? 'is-active bg-[#2f61b3] text-white' : 'bg-white text-neutral-800'); ?>"
                    >
                ...
                <?php else: ?>
                    <a
                        href="#<?php echo e($tab['target']); ?>"
                        data-dashboard-tab="<?php echo e($tab['target']); ?>"
                        aria-controls="<?php echo e($tab['target']); ?>"
                        aria-selected="<?php echo e(($tab['active'] ?? false) ? 'true' : 'false'); ?>"
                        class="admin-module-tab <?php echo e(($tab['active'] ?? false) ? 'is-active bg-[#2f61b3] text-white' : 'bg-white text-neutral-800'); ?>"
                    >
                        <i class="<?php echo e($tab['icon']); ?>"></i>
                        <span><?php echo e($tab['label']); ?></span>
        ...
        <div id="dashboard" data-dashboard-pane class="space-y-0">
            <div class="admin-dashboard-grid grid gap-3 p-3 xl:grid-cols-[minmax(0,4fr)_minmax(260px,1fr)_minmax(260px,1fr)]">
                <div class="admin-metric-grid grid gap-3 md:grid-cols-2 2xl:grid-cols-4">
                    <?php $__currentLoopData = $metricCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="admin-metric-card flex min-h-[74px] items-center gap-3 rounded-xl border border-neutral-300 bg-white px-3 shadow-sm">
                            <div class="admin-metric-icon <?php echo e($card['color']); ?> w-10 text-center text-4xl leading-none" style="<?php echo e($card['style']); ?>">
                                <i class="<?php echo e($card['icon']); ?>"></i>
                            </div>
                            <div class="min-w-0">
                                <p class="admin-card-title <?php echo e($card['color']); ?> text-sm font-medium" style="<?php echo e($card['style']); ?>"><?php echo e($card['label']); ?></p>
                                <p class="admin-card-value text-sm font-bold text-blue-700"><?php echo e($card['value']); ?></p>
                                <?php if($card['meta']): ?>
                                    <p class="admin-card-meta <?php echo e($card['color']); ?> text-sm font-semibold" style="<?php echo e($card['style']); ?>"><?php echo e($card['meta']); ?></p>
                                <?php endif; ?>
                            </div>
                        </article>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <article class="admin-summary-card flex min-h-[248px] flex-col justify-end rounded-xl border border-neutral-300 bg-white p-3 shadow-sm">
                    <div class="admin-stat-line mb-2 flex items-center justify-between border-b border-neutral-200 pb-2 text-sm text-emerald-600">
                        ...
                        <span class="rounded border border-emerald-500 px-1"><?php echo e($stats['students'] ?? 0); ?></span>
                    </div>
                ...
                <article class="admin-summary-card admin-donut-card flex min-h-[248px] flex-col justify-center rounded-xl border border-neutral-300 bg-white p-3 shadow-sm">
                    ...
                    <div class="admin-stat-line mb-2 flex items-center justify-between border-b border-neutral-200 pb-2 text-sm text-emerald-600">
                        ...
                        <span class="rounded border border-emerald-500 px-1"><?php echo e($stats['staff'] ?? 0); ?></span>
                    </div>
                    <div class="admin-stat-line mb-2 flex items-center justify-between border-b border-neutral-200 pb-2 text-sm text-sky-500">
            ...
            <div class="admin-panels-row grid gap-3 px-3 pb-3 xl:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
                <div class="admin-three-panels grid gap-3 lg:grid-cols-3">
                    <?php $__currentLoopData = $progressPanels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title => $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <section class="admin-panel overflow-hidden rounded-xl bg-white shadow-lg">
                            <h2 class="admin-panel-title bg-[#2f61b3] px-2 py-1 text-sm font-semibold text-white"><?php echo e($title); ?></h2>
                                ...
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="admin-progress-row">
                                        ...
                                        <div class="admin-progress-track h-1.5 bg-neutral-200">
                                            <div class="admin-progress-fill h-full <?php echo e($row['color']); ?>" style="width: <?php echo e($row['width']); ?>; <?php echo e($row['style']); ?>"></div>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
        ...
        <div id="modules" data-dashboard-pane class="hidden p-[10px]">
            <div class="legacy-dashboard-card-grid">
                <?php $__currentLoopData = $moduleCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($card['href']); ?>" class="legacy-dashboard-card">
                        <img src="<?php echo e(asset('assets/images/db/'.$card['image'])); ?>" alt="<?php echo e($card['label']); ?>">
        ...
        <div id="reports" data-dashboard-pane class="hidden p-3">
            <div class="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                <?php $__currentLoopData = $reportCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($card['href']); ?>" class="flex min-h-[110px] items-center gap-3 rounded-xl border border-neutral-300 bg-white px-4 py-5 shadow-sm transition hover:border-[#2f61b3] hover:shadow-md">
                        <span class="flex h-12 w-12 items-center justify-center rounded-full bg-[#eef4ff] text-2xl text-[#2f61b3]">
                            <i class="<?php echo e($card['icon']); ?>"></i>
                        </span>
                        <span class="text-sm font-semibold tracking-wide text-neutral-800"><?php echo e($card['label']); ?></span>
                    </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div id="cms" data-dashboard-pane class="hidden p-[10px]">
            <div class="legacy-dashboard-card-grid">
                <?php $__currentLoopData = $cmsCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($card['href']); ?>" class="legacy-dashboard-card">
                        <img src="<?php echo e(asset('assets/images/db/'.$card['image'])); ?>" alt="<?php echo e($card['label']); ?>">
                        <span><?php echo e($card['label']); ?></span>
                    </a>
        ...
        <div id="lms" data-dashboard-pane class="hidden p-[10px]">
            <div class="legacy-dashboard-card-grid">
                <?php $__currentLoopData = $lmsCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e($card['href']); ?>" class="legacy-dashboard-card">
                        <img src="<?php echo e(asset('assets/images/db/'.$card['image'])); ?>" alt="<?php echo e($card['label']); ?>">
                        <span><?php echo e($card['label']); ?></span>
                    </a>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\TNT\cmslv_git_clone2\resources\views\admin\dashboard\index.blade.php ENDPATH**/ ?>