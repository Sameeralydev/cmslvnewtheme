...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('assets/themes/default/fontawesome/css/all.min.css')); ?>">
    ...
    <body class="admin-body bg-[#f3f6f8] text-neutral-900">
        ...
        <script>
            window.adminRoutes = {
                dashboard: <?php echo json_encode(route('admin.dashboard'), 15, 512) ?>,
                staff: <?php echo json_encode(route('admin.staff.index'), 15, 512) ?>,
                report: <?php echo json_encode(route('admin.report.index'), 15, 512) ?>,
                frontcms: <?php echo json_encode(route('admin.frontcms.index'), 15, 512) ?>,
                membership: <?php echo json_encode(route('admin.membership.index'), 15, 512) ?>,
                qms: <?php echo json_encode(route('admin.qms.index'), 15, 512) ?>,
                systemNotification: <?php echo json_encode(route('admin.system-notification.index'), 15, 512) ?>,
            };
...
<?php /**PATH C:\xampp\htdocs\TNT\cmslv_git_clone2\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>