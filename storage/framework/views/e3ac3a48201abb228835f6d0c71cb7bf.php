...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('admin.academics.partials.nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <section class="overflow-x-auto rounded border border-neutral-200 bg-white">
        <div class="border-b border-neutral-200 px-4 py-3">
            <p class="text-sm text-neutral-500">Table: <?php echo e($module['table']); ?></p>
        </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\TNT\cmslv_git_clone2\resources\views\admin\academics\modules\index.blade.php ENDPATH**/ ?>