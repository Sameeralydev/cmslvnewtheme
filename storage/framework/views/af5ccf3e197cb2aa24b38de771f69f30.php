...
<aside class="admin-sidebar" style="display:block;position:fixed;top:0;left:0;bottom:0;width:var(--admin-sidebar-width);background:#2d4b94;color:#fff;z-index:30;box-shadow:0 2px 8px rgba(0,0,0,.24);overflow:hidden;">
    <div style="height:54px;padding:10px 8px;border-bottom:1px solid rgba(255,255,255,.08);display:flex;align-items:center;gap:8px;">
        ...
        <a href="<?php echo e(route('admin.dashboard', absolute: false)); ?>" style="color:#ffffff;text-decoration:none;font-size:11px;font-weight:600;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
        ...
        <?php $__currentLoopData = $sidebarItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($item['children'] !== []): ?>
                <div style="border-bottom:1px solid rgba(255,255,255,.06);">
                    <a
                        data-sidebar-toggle
                        data-sidebar-target="sidebar-menu-<?php echo e($item['key']); ?>"
                        aria-expanded="<?php echo e($isExpanded ? 'true' : 'false'); ?>"
                        href="<?php echo e($item['route'] ? route($item['route'], absolute: false) : request()->fullUrlWithQuery(['menu' => $item['key']])); ?>"
                        style="display:flex;align-items:center;gap:10px;padding:11px 10px;color:#fff;text-decoration:none;font-size:11px;font-weight:600;background:<?php echo e($isExpanded ? '#3b61ad' : 'transparent'); ?>;"
                    >
                        <span style="width:16px;text-align:center;font-size:13px;flex:0 0 16px;"><i class="<?php echo e($item['icon']); ?>"></i></span>
                        <span style="flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo e($item['label']); ?></span>
                        <span style="font-size:12px;"><i data-sidebar-chevron class="fa fa-angle-<?php echo e($isExpanded ? 'down' : 'right'); ?>"></i></span>
                    </a>

                    <div
                        id="sidebar-menu-<?php echo e($item['key']); ?>"
                        class="admin-sidebar-tree <?php echo e($isExpanded ? 'is-open' : ''); ?>"
                        style="<?php echo e($isExpanded ? '--sidebar-tree-height:520px;' : ''); ?>padding:2px 0;"
                    >
                        <?php $__currentLoopData = $item['children']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <a
                                ...
                                style="display:flex;align-items:center;gap:8px;padding:6px 14px 6px 12px;color:#fff;text-decoration:none;font-size:10px;font-weight:600;background:<?php echo e($childIsCurrent ? '#31508f' : 'transparent'); ?>;"
                            >
                                <i class="fa fa-angle-double-right" style="font-size:9px;opacity:.9;"></i>
                                <span style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo e($child['label']); ?></span>
                            </a>
            ...
            <?php else: ?>
                <a
                    href="<?php echo e($item['route'] ? route($item['route'], absolute: false) : '#'); ?>"
                    style="display:flex;align-items:center;gap:10px;padding:11px 10px;border-bottom:1px solid rgba(255,255,255,.06);color:#fff;text-decoration:none;font-size:11px;font-weight:600;background:<?php echo e($itemIsActive ? '#1f3b7d' : 'transparent'); ?>;"
                >
                    <span style="width:16px;text-align:center;font-size:13px;flex:0 0 16px;"><i class="<?php echo e($item['icon']); ?>"></i></span>
                    <span style="flex:1;min-width:0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo e($item['label']); ?></span>
                    <?php if (! ($loop->first)): ?>
...
<?php /**PATH C:\xampp\htdocs\TNT\cmslv_git_clone2\resources\views\admin\partials\sidebar.blade.php ENDPATH**/ ?>