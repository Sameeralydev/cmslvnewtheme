...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('teacher.partials.nav', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <form method="POST" action="<?php echo e(route('teacher.password.update')); ?>" class="max-w-xl rounded border border-neutral-200 bg-white p-4">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('teacher.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\TNT\cmslv_git_clone2\resources\views\teacher\password\edit.blade.php ENDPATH**/ ?>