...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>Staff Login - <?php echo e(config('app.name', 'Laravel')); ?></title>
    ...
    <body class="min-h-screen bg-neutral-100 text-neutral-900">
        <main class="flex min-h-screen items-center justify-center px-4 py-10">
            <section class="w-full max-w-md rounded-lg border border-neutral-200 bg-white p-6 shadow-sm">
                ...
                <form method="POST" action="<?php echo e(route($loginRouteName, absolute: false)); ?>" class="space-y-4">
                    <?php echo csrf_field(); ?>

                    <div>
                        <label for="staff-email" class="mb-1 block text-sm font-medium text-neutral-700">Staff email or employee ID</label>
                        <input id="staff-email" name="email" type="text" value="<?php echo e(old('email')); ?>" autocomplete="username" required autofocus class="w-full rounded-md border border-neutral-300 px-3 py-2 text-sm outline-none focus:border-neutral-900 focus:ring-2 focus:ring-neutral-200">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="flex items-center justify-between gap-3">
                        <label for="staff-remember" class="flex items-center gap-2 text-sm text-neutral-600">
                            <input id="staff-remember" name="remember" type="checkbox" value="1" <?php if(old('remember')): echo 'checked'; endif; ?> class="h-4 w-4 rounded border-neutral-300">
                            Remember me
                        </label>

                        <a href="<?php echo e(route('staff.forgot_password', absolute: false)); ?>" class="text-sm font-medium text-blue-700">Forgot password?</a>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\TNT\cmslv_git_clone2\resources\views\staff\auth\login.blade.php ENDPATH**/ ?>