...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', 'Teacher Portal'); ?></title>
    ...
    <body class="bg-neutral-100 text-neutral-900">
        <main class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            ...
            <header class="mb-6 flex flex-col gap-3 border-b border-neutral-200 pb-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <p class="text-sm font-medium text-neutral-500">CodeIgniter-compatible teacher module</p>
                    <h1 class="text-2xl font-semibold"><?php echo $__env->yieldContent('title', 'Teacher Portal'); ?></h1>
                </div>
...
<?php /**PATH C:\xampp\htdocs\TNT\cmslv_git_clone2\resources\views\teacher\layouts\app.blade.php ENDPATH**/ ?>