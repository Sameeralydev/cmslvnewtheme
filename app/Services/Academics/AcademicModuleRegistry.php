...
class AcademicModuleRegistry
{
    ...
    public function all(): array
    {
        return [
            ...
            'syllabus-directory' => $this->module('Syllabus Directory', Syllabus::class, 'syllabus', 'admin.academics.syllabus-directory.index', 'syllabus', ['presentation', 'attachment', 'vid_title'], ['class_id', 'section_id', 'subject_id', 'term_id', 'status']),
