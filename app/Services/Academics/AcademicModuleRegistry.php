...
class AcademicModuleRegistry
{
    ...
    public function all(): array
    {
        return [
            ...
            'domain-modules' => $this->module('Modules', DomainModule::class, 'domainmodules', 'admin.academics.domain-modules.index', 'domainmodules', ['name', 'urdu', 'note'], ['name', 'urdu', 'is_active']),
