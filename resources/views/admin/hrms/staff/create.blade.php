                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            <a class="btn btn-sm btn-primary" href="{{ route('admin.hrms.staff.import', ['brc_id' => $selectedBranchId], false) }}" autocomplete="off">
                                <i class="fa fa-plus"></i> Import Staff
                            </a>
                        </div>
                    </div>

                    <form id="form1" action="{{ route('admin.hrms.staff.store', ['branchId' => $selectedBranchId], false) }}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="brc_id" name="brc_id" class="form-control selectval brc_id" onchange="window.location='{{ route('admin.hrms.staff.create', absolute: false) }}/'+this.value;">
                                                    <option value="">Select</option>
                                                    @foreach ($branches as $branch)
                                                        <option value="{{ $branch->id }}" @selected((int) old('brc_id', $selectedBranchId) === (int) $branch->id)>{{ $branch->name }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input autofocus id="employee_id" name="employee_id" type="text" class="form-control" value="{{ old('employee_id', $generatedEmployeeId) }}" readonly>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="category" name="category" class="form-control selectval">
                                                    <option value="">Select</option>
                                                    <option value="1" @selected((string) old('category') === '1')>Administration</option>
                                                    <option value="2" @selected((string) old('category') === '2')>Teaching</option>
                                                    <option value="3" @selected((string) old('category') === '3')>Allied</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="role" name="role" class="form-control selectval">
                                                    ...
                                                    @foreach ($roles as $role)
                                                        <option value="{{ $role['id'] }}" @selected((string) old('role', old('role_id')) === (string) $role['id'])>{{ $role['name'] }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="designation" name="designation" class="form-control selectval">
                                                    ...
                                                    @foreach ($designations as $designation)
                                                        <option value="{{ $designation->id }}" @selected((string) old('designation') === (string) $designation->id)>{{ $designation->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="department" name="department" class="form-control selectval">
                                                    ...
                                                    @foreach ($departments as $department)
                                                        <option value="{{ $department->id }}" @selected((string) old('department') === (string) $department->id)>{{ $department->name }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="father_name" name="father_name" type="text" class="form-control" value="{{ old('father_name') }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="cnic" name="cnic" type="text" class="form-control" value="{{ old('cnic') }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="email" name="username" type="text" class="form-control" value="{{ old('username', old('email')) }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="dob" name="dob" type="date" class="form-control date" value="{{ old('dob') }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="date_of_joining" name="date_of_joining" type="date" class="form-control date" value="{{ old('date_of_joining') }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Phone</label>
                                                <input id="mobileno" name="contactno" type="text" class="form-control" value="{{ old('contactno', old('contact_no')) }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="emergency_no" name="emergency_no" type="text" class="form-control" value="{{ old('emergency_no', old('emergency_contact_no')) }}">
                                                <span class="text-danger">{{ $errors->first('emergency_contact_no') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="whatsapp_no" name="whatsapp_no" type="text" class="form-control" value="{{ old('whatsapp_no') }}">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" class="form-control">{{ old('address', old('local_address')) }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <tr>
                                                    <td>
                                                        <select id="eduinst" name="eduinst[]" class="form-control selectval">
                                                            <option value="">Select</option>
                                                            @foreach ($universityBoards as $board)
                                                    ...
                                                    <td>
                                                        <select id="edudegree" name="edudegree[]" class="form-control selectval">
                                                            <option value="">Select</option>
                                                            @foreach ($degreeCertificates as $degree)
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="contract_type">
                                                    ...
                                                    @foreach ($contractTypes as $key => $value)
                                                        <option value="{{ $key }}" @selected(old('contract_type') === $key)>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="shift">
                                                    ...
                                                    @foreach ($shiftOptions as $key => $value)
                                                        <option value="{{ $key }}" @selected(old('shift') === $key)>{{ $value }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="total_security" name="total_security" type="text" class="form-control" value="{{ old('total_security') }}">
                                                    <span class="text-danger">{{ $errors->first('total_security') }}</span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Per Month Security</label>
                                                    <input id="per_month_security" name="per_month_security" type="text" class="form-control" value="{{ old('per_month_security') }}">
                                                    <span class="text-danger">{{ $errors->first('month_security') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <select name="salary_ded_type[]" class="form-control selectval">
                                                                <option value="">Select</option>
                                                                @foreach ($payDeductionTypes as $payType)
                                                                    <option value="{{ $payType->id }}">{{ $payType->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="account_title" name="account_title" type="text" class="form-control" value="{{ old('account_title') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="bank_account_no" name="bank_account_no" type="text" class="form-control" value="{{ old('bank_account_no') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="bank_name" name="bank_name" type="text" class="form-control" value="{{ old('bank_name') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="IBAN_code" name="IBAN_code" type="text" class="form-control" value="{{ old('IBAN_code', old('iban_code')) }}">
                                                <span class="text-danger">{{ $errors->first('iban_code') }}</span>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Bank Branch Name</label>
                                                <input id="bank_branch" name="bank_branch" type="text" class="form-control" value="{{ old('bank_branch') }}">
                                ...
                                <div class="row around10">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input name="twitter" type="text" class="form-control" value="{{ old('twitter') }}">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('first_doc') }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>3.</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('fourth_doc') }}</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <span class="text-danger">{{ $errors->first('second_doc') }}</span>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('assets/dist/js/savemode.js') }}"></script>
@endpush
