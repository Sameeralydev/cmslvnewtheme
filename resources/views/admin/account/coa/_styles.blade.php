<style>
    ...
    .legacy-coa .sub-acc-type {
        margin-bottom: 6px;
    }

    .legacy-coa .sub-acc-type > a {
        color: #337ab7;
        font-size: 13px;
        text-decoration: none;
        display: inline-block;
    ...
    .legacy-coa .sub-acc-type > a:hover {
        color: #23527c;
        text-decoration: underline;
    }

    .legacy-coa .sub-acc-items {
    ...
    .legacy-datatable-toolbar input:focus {
        border-color: #24448d;
    }
    ...
    .legacy-datatable-icons span:hover {
        background: #1a336f;
    }

    .legacy-coa th.sortable {
        cursor: pointer;
        user-select: none;
    }

    .legacy-coa th.sortable:hover {
        background: #1e3977;
    }

    /* Print View */
    @media print {
        .legacy-datatable-toolbar, .legacy-coa .nav-tabs, .admin-topbar, .admin-sidebar, .main-footer {
